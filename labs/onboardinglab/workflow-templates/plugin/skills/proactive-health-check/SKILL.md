...
description: Assess checkout availability, failures, latency, dependencies, and Azure resource health using read-only evidence.
---

# Proactive health check

Use the connected application telemetry and read-only Azure tools to assess the ticketing checkout service.

1. Confirm the UTC analysis window and the Application Insights resource being queried.
2. Measure checkout request volume, availability, failure rate, and latency over the last 24 hours.
