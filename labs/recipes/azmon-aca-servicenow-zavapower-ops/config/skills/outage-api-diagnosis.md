...
## Scope
The **outage-api** is a Python/Flask service (`{{AZ_APP_PREFIX}}-outage`) that manages power outage reports. This skill guides you through a systematic investigation of any failure in this service — from detecting symptoms, through root-cause analysis of Python tracebacks, to applying the appropriate fix.
...
| where ContainerAppName_s == "{{AZ_APP_PREFIX}}-outage"
