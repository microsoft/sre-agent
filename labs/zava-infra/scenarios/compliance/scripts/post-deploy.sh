...
# Disable Git-Bash MSYS path translation — `curl --data-binary @/tmp/...`
# otherwise gets rewritten to `C:/Program Files/Git/tmp/...` and fails
...
LAB_NAME="deployment-compliance"
