...
output "agent_vnet_id" {
  description = "Resource ID of the SRE Agent VNet."
  value       = azurerm_virtual_network.agent.id
}

output "splunk_vnet_id" {
  description = "Resource ID of the private Splunk VNet."
  value       = azurerm_virtual_network.splunk.id
}
...
output "splunk_hostname" {
  description = "Private DNS hostname resolvable from both lab VNets."
